...
(function () {
  ...
  s.textContent = [
    ...
    '  --cc-link-color: #f0c94a;',
    '  --cc-btn-primary-bg: #d4a017;',
    '  --cc-btn-primary-border-color: #d4a017;',
    '  --cc-btn-primary-color: #12071f;',
    '  --cc-btn-primary-hover-bg: #f0c94a;',
    '  --cc-btn-primary-hover-border-color: #f0c94a;',
    '  --cc-btn-primary-hover-color: #12071f;',
    '  --cc-btn-secondary-bg: #1e0f35;',
    '  --cc-btn-secondary-color: #f0e6d3;',
    '  --cc-btn-secondary-border-color: #3d2366;',
    '  --cc-btn-secondary-hover-bg: #2a1650;',
    '  --cc-btn-secondary-hover-border-color: #3d2366;',
    '  --cc-btn-secondary-hover-color: #f0e6d3;',
    '  --cc-separator-border-color: #3d2366;',
    '  --cc-footer-bg: #1e0f35;',
    '  --cc-footer-color: #f0e6d3;',
    '  --cc-footer-border-color: #3d2366;',
