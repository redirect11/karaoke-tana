...
echo -e "    docker exec -it karaoke-tana-dev /workspace/scripts/dev-reset.sh   ← reset DB + seed admin"
echo -e "    docker exec -it karaoke-tana-dev supabase status"
echo -e "    docker exec -it karaoke-tana-dev bash"
echo ""
echo -e "  ${YELLOW}Attenzione:${NC} usa dev-reset.sh invece di 'supabase db reset'"
echo -e "  per non perdere l'utente admin dopo il reset."
echo ""
echo -e "${BOLD}════════════════════════════════════════${NC}"
echo ""
